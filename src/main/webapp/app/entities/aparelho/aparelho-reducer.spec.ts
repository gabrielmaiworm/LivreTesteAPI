...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aparelho.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APARELHO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APARELHO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APARELHO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APARELHO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APARELHO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APARELHO actions', async () => {
      const expectedActions = [
        {
